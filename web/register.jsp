...
<html lang="en">
    ...
    <body>
        <div class="register-box">
            <img src="${pageContext.request.contextPath}/img_avatar1.png" alt="Register Logo">
            ...
            <form action="RegisterServlet" method="post">
                ...
                <div class="mb-3">
                    ...
                    <div>
                        <input type="radio" id="male" name="gender" value="true" ${param.gender == 'true' ? 'checked' : ''} required>
                        <label for="male">Male</label>
                        <input type="radio" id="female" name="gender" value="false" ${param.gender == 'false' ? 'checked' : ''} required>
                ...
                <input type="hidden" name="roleInSystem" value="3">
