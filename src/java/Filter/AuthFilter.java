...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        DTOAccount user = (session != null) ? (DTOAccount) session.getAttribute("loggedInUser") : null;

        String path = req.getRequestURI();
        String contextPath = req.getContextPath();

        boolean isPublicPage = path.equals(contextPath)
                || path.equals(contextPath + "/")
                || path.endsWith("index.jsp")
                || path.endsWith("login.jsp")
                || path.endsWith("register.jsp")
                || path.endsWith("Explore.jsp")
                || path.endsWith("ProductDetails")
                || path.endsWith("searchProduct")
        ...
        boolean isRestrictedPage = path.contains("/AccountServlet")
                || path.contains("/CategoryServlet")
                || path.contains("/ProductServlet")
                || path.contains("/AddAcc")
                || path.contains("/AddCategory")
