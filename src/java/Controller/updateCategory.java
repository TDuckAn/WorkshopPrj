...
public class updateCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DTOCategory category = new DTOCategory(typeId, categoryName, memo);
            DAOCategory dao = new DAOCategory();
            boolean success = dao.updateRec(category);
            ...
            if (success) {
                ...
                request.getRequestDispatcher("/private/categoryupdate.jsp").forward(request, response);
            }
